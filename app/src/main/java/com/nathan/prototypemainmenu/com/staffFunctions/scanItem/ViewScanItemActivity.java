...
public class ViewScanItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_scan_item_screen);
        getSupportActionBar().setTitle("View Scan Item");
        ...
        serviceReceiver = new ViewScanItemActivity.ServiceReceiver();
    ...
    public void onClickBtnBack(View view) {
        ViewScanItemActivity.this.finish();
